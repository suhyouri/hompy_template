...
export const APPS_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbxZPx5fopkAdlZxcWWyIcZC4kdXA3gqcGScMSDbOb8nAoJK2YQ_nKrDgPJdUEdl6Vk/exec](https://script.google.com/macros/s/AKfycbxZPx5fopkAdlZxcWWyIcZC4kdXA3gqcGScMSDbOb8nAoJK2YQ_nKrDgPJdUEdl6Vk/exec"; // IMPROVEMENT: 중앙 집중화된 Apps Script URL
...
function isValidLocalHtmlFileName(fileName) {
  ...
  if (
    ...
    console.warn(
      "Path traversal attempt detected in local HTML file name:",
      fileName
    );
    return false;
  }
...
export function getEmbedURL(type, id) {
  ...
  switch (
    type.toLowerCase() // 게시물 타입을 소문자로 변환하여 비교합니다.
  ) {
